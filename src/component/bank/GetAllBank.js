      ...
      <>
        ...
        <div>
          {/* {isModalOpen && <UpdateModal
            value={bank}
            checkPage={checkPage} changeshow={true} closeModal={() => setIsModalOpen(false)} 
          />} */}
          ...
          <div className="formforbank">
            ...
            <div className="display-table">
              ...
              <Table data={data} deleteFunction={deleteBank} updateFunction={updateBank} checkPage={checkPage}>
              </Table>
            </div>
